							...
							<Row>
								{this.props.publicView === true && 
									<Col xs="4" sm="3" md="3"  lg="3" xl="2" className="" style={{marginTop: "1.2%" }}>
										<img className="navbar-brand-img" src={require("assets/img/public-view/public-view-logo.png")}  />
									</Col>	
								}
								<Col xs="8" sm="9" md="9" lg="6" xl="4" className="">
									<Row>
										<div className="col">
											...
											<span className="mb-0" style={{fontSize:"30px", fontWeight: 800, fontStyle:"normal", letterSpacing: "-0.03em", color: "#404040", lineHeight: "38px"}}>
												{this.showLoadingElseContent(this.props.timeline.name)}
											</span>
											<p className="mt-0 mb-0" style={{opacity: 0.7, fontFamily: "Space Mono", fontSize: "14px" , fontStyle: "normal", fontWeight: "normal", letterSpacing: "2px", color: "#6F6C99", leeight: "38px"}}>
									...
									<Col lg="6" xl="4">
										<Row>
											<Col xs="3" sm="3" lg="3" xl="3">
												...
												<span className="mb-0" style={{ fontStyle:"normal", fontWeight:800, fontSize:"20px", lineHeight: "26px", letterSpacing: "-0.03em", color: "#404040"}}>
													{/*01.07.20*/} 
												...
												<p className="mt-2 mb-0 " style={{fontFamily: "Space Mono", fontSize: "14px" , fontStyle: "normal", fontWeight: "normal", letterSpacing: "0px", color: "#6F6C99", lineHeight: "20px"}}>
									...
									<Col xs="6" sm="6" lg="4" xl="4">
										<Row>
											<Col xs="9" sm="6" lg="4" xl="4" >
												{this.showLoadingElseContent(
													<button className="btn btn-dark" style={{background: "#404040", borderRadius: "9px"}}>
											...
											<Col xs="3" sm="6" lg="4" xl="4">
												{this.showLoadingElseContent(<button className="btn btn-outline-dark" style={{borderRadius: "9px"}}>
