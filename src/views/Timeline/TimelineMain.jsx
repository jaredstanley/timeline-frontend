	...
	render() {
		return (
			<React.Fragment>
				...
				<NewGroupFormModal modal={this.state.modalOpen} toggle={this.toggle}></NewGroupFormModal>
				<NewItemFormModal modal={this.state.itemModalOpen} toggle={this.itemModalToggle}></NewItemFormModal>
			</React.Fragment>
		);
	}
